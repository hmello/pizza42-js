...
const updateUI = async () => {
  try {
    ...
    if (isAuthenticated) {
      ...
      eachElement(".order-pizza", (e) => e.classList.remove("hidden"));      

      eachElement(".profile-image", (e) => (e.src = user.picture));
      eachElement(".user-name", (e) => (e.innerText = e.innerText + user.name));
      eachElement(".user-user_metadata", (e) => (e.innerText = user.user_metadata));
      eachElement(".user-email_verified", (e) => (e.innerText = user.email_verified));
      ...
      //Order NOW
      eachElement(".order-pizza", (e) => e.classList.add("hidden"));
    }
  } catch (err) {
